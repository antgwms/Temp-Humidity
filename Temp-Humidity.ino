// 17/04/2018 - Written by Anthony Williams @antgwms
...
//String txtHumidity   = "";   // Humidity text
...
void setup() {
  ...
  Serial.begin(9600);                // was debug, now serial comms to be initialized for data communication from Arduino; to processing for prototyping
...
void loop() {
  ...
  Serial.print("Heat Temp: ");
  Serial.print(tempHeatC, 1);
  Serial.print(" *C");
  Serial.println(",");

  //also try to send the data via serial link to processing on the PC
